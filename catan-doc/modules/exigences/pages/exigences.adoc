...
.Cas d'utilisation Finir la partie
...
[%hardbreaks]
Les exigences de sécurité suivantes doivent être satisfaites :
...
Il doit être possible d'ajouter des règles de jeu supplémentaires.
Ainsi que des cartes supplémentaires.
