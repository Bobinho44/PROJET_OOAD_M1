...
Alors que le premier diagramme nous montrait un communication assez standard, ce deuxième diagramme permet de visualiser les interactions entre les clients et le serveur en cas de requête nécessitant plusieurs interactions des clients vers le serveur.
