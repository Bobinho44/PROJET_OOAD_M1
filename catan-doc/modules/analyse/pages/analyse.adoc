...
*pré-condition*
    Le joueur possède assez de ressource du même type
...
Le joueur peut construire une route sur un chemin en échange de ressource. Cette route peut uniquement être construite sur une intersection voisine à une route, une colonie ou une ville de sa couleur

*pré-condition*
    Le joueur a les ressource pour construire une route
    Un emplacement valide est disponible pour construire la route
*post-condition*
    Le joueur a perdu les ressources liées au coût de construction
